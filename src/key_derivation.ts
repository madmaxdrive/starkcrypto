...
*/
export function getAccountPath(layer: string, application: string, ethereumAddress: string, index: number) {
...
*/
export function grindKey(keySeed: string, keyValLimit: BN) {
